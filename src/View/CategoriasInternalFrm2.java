...
public class CategoriasInternalFrm2 extends javax.swing.JInternalFrame {
        Categoria c = new Categoria();
        CategoriasInternalFrm2 cif2 = new CategoriasInternalFrm2();
        CategoriaController cc = new CategoriaController(cif2);
    
    public CategoriasInternalFrm2() {
        initComponents();
        cc.verTabla();
//        cif2.setVisible(true);
